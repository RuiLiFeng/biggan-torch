...
class Generator(nn.Module):
    def __init__(self, G_ch=64, dim_z=128, bottom_width=4, resolution=128,
                 ...
                 G_param='SN', norm_style='bn', labeled_percent=0.01,
                 **kwargs):
        ...
        # Input to encoder must be [NCHW], C=3, H=W=128
        self.encoder = Encoder(latent_dim=self.dim_z, labeled_percent=labeled_percent)
    ...
    def forward(self, z, y, x=None, mode='inv'):
